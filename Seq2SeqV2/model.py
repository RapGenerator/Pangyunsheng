...
class Seq2SeqModel(object):
    ...
    def create_rnn_cell(self):
        ...
        """
        cell = MultiRNNCell([self.single_rnn_cell() for _ in range(self.num_layers)])
        return cell

    def create_bi_rnn_cell(self):
        cell_fw = [self.single_rnn_cell() for _ in range(self.num_layers)]
        cell_bw = [self.single_rnn_cell() for _ in range(self.num_layers)]
